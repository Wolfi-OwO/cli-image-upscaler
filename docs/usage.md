...
| `--strength FLOAT` | `1.0` | Blend AI vs. natural detail (Real-ESRGAN only): `1.0` = full AI, `~0.7` natural-ish, `0.0` = plain resize. Lower it to reduce the over-smoothed/hallucinated "AI look". |
